  ...
  return (
    <div className="space-y-6">
      ...
      <div className="p-4 border rounded-lg">
        <div className="font-medium">Local Dictation Shortcut</div>
        <div className="text-sm text-gray-600 mt-1">
          Hold <kbd className="px-1.5 py-0.5 border rounded bg-gray-50">Control + Option + Space</kbd>{' '}
          to dictate with your downloaded transcription model. Release to copy the text, then press Command + V to paste.
        </div>
      </div>
