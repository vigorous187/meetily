...
pub struct ModelDef {
    ...
    /// Exact trusted file size in bytes.
    pub expected_size_bytes: u64,

    /// SHA-256 published by the pinned model repository revision.
...
pub fn get_available_models() -> Vec<ModelDef> {
    vec![
        ...
        ModelDef {
            ...
            expected_sha256: "aaf42c8b7c3cab2bf3d69c355048d4a0ee9973d48f16c731c0520ee914699223".to_string(),
            context_size: 32768,
            layer_count: 24,
        ...
        ModelDef {
            ...
            expected_sha256: "00fe7986ff5f6b463e62455821146049db6f9313603938a70800d1fb69ef11a4".to_string(),
            context_size: 32768,
            layer_count: 32,
            sampling: SamplingParams::qwen35_summary(vec!["<|im_end|>".to_string()]),
        ...
        ModelDef {
            ...
            size_mb: 2374,
            expected_size_bytes: 2_489_758_112,
            expected_sha256: "4996030242583a40aa151ff93f49ed787ac8c25e4120c3ae4588b2e2a7d1ae94".to_string(),
            context_size: 32768,
            layer_count: 35,
        ...
        ModelDef {
            ...
            size_mb: 1019,
            expected_size_bytes: 1_069_306_624,
            expected_sha256: "375e12a4a18929a641f9744b060d4a7cf4e279530750555828ec0c117870bc96".to_string(),
            context_size: 32768,
            layer_count: 26,
            sampling: SamplingParams::gemma3_instruct(vec!["<end_of_turn>".to_string()]),
...
mod tests {
    ...
    fn qwen35_models_are_registered_with_expected_metadata() {
        ...
        assert_eq!(qwen_2b.expected_size_bytes, 1_280_835_840);
        assert_eq!(qwen_2b.expected_sha256, "aaf42c8b7c3cab2bf3d69c355048d4a0ee9973d48f16c731c0520ee914699223");
